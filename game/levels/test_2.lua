return {
	{"goal",    0, {533, 300}, {255, 255, 255}, "G",  {}, 5, "Checks it's input.\nif input equals goal,\nyou pass.\ngoal is 5."},
	{"crystal", 4, {400, 300}, {255, 255,   0}, "+",  {}, function(c, ...) local t=0; for _,v in ipairs({...}) do t=t+v  end; return t end, "Adds inputs together,\nand outputs the result.", ""},
