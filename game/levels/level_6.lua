...
return {
	...
	{"crystal", 4, {550, 250}, {128, 255, 128}, "×" , {}, function(c, a, ...) local t=(a or 0); for _,v in ipairs({...}) do t=t*v  end; return t end, "Multiplies inputs\n together."},
	--{"crystal", 4, {350, 300}, {200, 128, 200}, "^" , {}, function(c, a, ...) local t=(a or 0); local l={...}; if #l == 0 then return 1 end; for _,v in ipairs(l) do t=t^v  end; return t end, "This raises the first value\n by the second value."},
	{"crystal", 4, {350, 300}, {200, 128, 200}, "^" , {}, function(c, a, ...) local t=(a or 0); local l={...}; if #l == 0 then return 0 end; for _,v in ipairs(l) do t=t^v  end; return t end, "This raises the first value\n by the second value.\n(Special: does not assume 0 \n  exponent no input.\n Hint: Work it out yourself...)"},
